...
import FoodDeliveryJson from "../../../../../JsonApi/Company/OurOfferings/FoodDelivery/FoodDelivery.json";

const FoodDelivery = ()=>{

    const FoodDeliveryCmp = ({data})=>{
        const design = (
            <>
            ...
            <div className="row row-con">
                <div>
                    <Typography component="h4" className="title">
                        {FoodDeliveryJson.title}
                    </Typography>
                </div>
                {
                    FoodDeliveryJson.list.map((item)=>{
                        return <FoodDeliveryCmp data={item} key={item.id} />
                    })
                }
